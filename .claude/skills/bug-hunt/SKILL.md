...
argument-hint: <área/módulo a barrer> [foco opcional: concurrencia, datos, errores, seguridad]
---
...
Recorre cada zona priorizada con la taxonomía de `docs/DEBUGGING.md` §1 como checklist de ataque, apoyada en greps dirigidos (adapta al stack):
