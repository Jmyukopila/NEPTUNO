...
argument-hint: [ruta del proyecto] [android|ios] (por defecto: android)
---
...
5. **iOS**: `cap sync ios` copia los assets a `ios/App`, pero el compile (`xcodebuild`) requiere macOS/Xcode — imposible desde Windows. No lo intentes ni simules el resultado; deriva a la sección CI de `docs/CAPACITOR.md`.
