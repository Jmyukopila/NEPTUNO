...
1. **Node**: `node -v`. Cada SDK de Expo fija un mínimo (ver `docs/REACT-NATIVE.md` para la tabla de compatibilidad SDK↔RN↔Node del proyecto actual) — un Node más viejo que el mínimo del SDK instalado es la causa nº1 de fallos raros de instalación/build.
