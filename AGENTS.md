<!-- GENERADO por tools/sync-agents.js desde CLAUDE.md. No edites este archivo: los cambios se pierden en la próxima sincronización. Edita la fuente en .claude/. -->
