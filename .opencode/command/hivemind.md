...
Argumentos recibidos (formato esperado: <tarea a repartir>): $ARGUMENTS
...
**verificas**. Doctrina completa, fichas de cada agente y estado de verificación: `/home/jasen/.claude/docs/HIVEMIND.md`.
